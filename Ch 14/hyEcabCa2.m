...
%
% usage: [ca, t] = hyEcabCa2(cab,stim,pinc)
%
...
%           stim = struct('t1',1,'t2',3,'Tfin',10,'Iapp',300e-6,...
%           'BT',5e2,'knaca',100,'Jpmca',2e-6)
%           pinc = 20
%           [ca, t] = hyEcabCa2(cab,stim,pinc)
%

function [ca, t] = hyEcabCa2(cab,stim,pinc)
...
ICa = ICaT; ca = ICa; bca = ICa; INaCa = ca;

E = struct('K', -77, 'Na', 56, 'Cl', -68);
g = struct('K', 36, 'Na', 120, 'Cl', 1/15, ...
           'CaT', .25, 'CaN', 2.5, 'CaL', 2.5);
%           'CaT', 0, 'CaN', 0, 'CaL', 0);
...
subplot(4,1,2)
plot(t,ICa,'linewidth',1,'color','k')
axis tight
ylabel('I_{Ca}','fontsize',14,'color','k')
set(gca,'xticklabel',[])
box off

subplot(4,1,3)
plot(t,INaCa,'linewidth',1,'color','k')
axis tight
set(gca,'xticklabel',[])
ylabel('I_{NaCa}','fontsize',14,'color','k')
box off
...
axis tight
ylabel('b  (\muM)','fontsize',14,'color','k')
