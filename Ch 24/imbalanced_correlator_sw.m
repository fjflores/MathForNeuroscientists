...
%imbalance ratio between the two branches of the detector
i_r = 0.8;
...
legend([hp1 hp2],{'imbalanced correlator response', 'standard model'});
set(ha1,'TickDir','out');
set(ha1,'XLim',[0 1],'YLim',[-0.25 0.45]);

ha2 = subplot(2,1,2);
hp3 = plot(t_vect,r_hr_mean,'k');
legend([hp3],{'imbalanced spatially averaged response'});
%hold on;
...
%print(h_f,'figures/imbalance_component.eps','-depsc');
