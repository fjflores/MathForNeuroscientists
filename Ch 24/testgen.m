function S = testgen(xsize,ysize,tsize,glider,parity)
%Glider stimulus generation
%   S = testgen(xsize,ysize,tsize,rule,parity);
%   Input:
...
%          S = testgen(64,64,20,glider,parity);
%     Each glider has a different ruleset.
%          Std. first-order motion: glider = [0 0 0;1 0 1]
