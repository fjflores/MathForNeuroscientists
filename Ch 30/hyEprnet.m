...
%
%  examples (use output arg in subsequent runs on same net)
%
%   A = hyEprnet(.01,2000,100,.2,0.0045,0.007,2000)   % fig 27.27A
%   hyEprnet(.01,2000,100,.2,0.0045,0.005,2000,A)     % fig 27.27B
%   hyEprnet(.01,2000,100,.2,0.0045,0.007,400,A)      % fig 27.28
%
%   note that rhythmic behavior is not dependent on the precise adj
%
